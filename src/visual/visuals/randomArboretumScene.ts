...
export class RandomArboretumScene {
  ...
  private segments: Branch[] = [];
  private maxSegs = 22000;
  private segCount = 0;
  ...
  private growOne(params: {
    ...
    if (this.segCount >= this.maxSegs) return;
    ...
    const n: Branch = { x0: b.x1, y0: b.y1, x1: nx, y1: ny, depth: b.depth + 1 };
  ...
  update(control: ControlState) {
    ...
    for (let i = 0; i < ticks; i++) {
      ...
      if (this.segCount >= this.maxSegs) break;
    }
