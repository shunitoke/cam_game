...
export class CoyoteFractalFlightScene {
  ...
  triggerBurst(amount: number) {
    ...
    this.mat.uniforms.uBurst.value = Math.max(this.mat.uniforms.uBurst.value as number, a);
  }
  ...
  update(control: ControlState) {
    ...
    const burst = clamp01((this.mat.uniforms.uBurst.value as number) - control.dt * 1.8);
